...
export const BodyBackFemale: FC<BodySvgProps> = ({ gp }) => (
	<svg
	...
	>
		...
		<g id="rear-shoulders" {...gp?.('rear_delts')}>
			<path
		...
		<g id="traps-middle" {...gp?.('upper_back')}>
			<path
