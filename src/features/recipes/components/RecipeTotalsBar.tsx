...
export interface RecipeTotalsBarProps {
	...
	/** Totals minus discarded fat — shown as a deduction line when they differ */
	consumed?: AbsoluteMacros
	discardedFat?: number | null
}

export const RecipeTotalsBar: FC<RecipeTotalsBarProps> = ({ totals, consumed, discardedFat }) => {
	return (
