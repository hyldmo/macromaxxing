import { EQUIPMENT, EQUIPMENT_LABELS, type Equipment } from '@macromaxxing/db'
...
/** Toggle-chip checklist over the fixed equipment vocabulary. Shared by the location editor and exercise form. */
		...
		<div className="flex flex-wrap gap-1.5">
			{EQUIPMENT.map(eq => (
				<button
					...
					type="button"
					disabled={disabled}
					onClick={() => onChange(active.has(eq) ? selected.filter(e => e !== eq) : [...selected, eq])}
					className={cn(
