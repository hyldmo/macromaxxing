...
import { buildSupersetRounds, isHardSet, loggedVolume, type PlannedSet, weightStepKg } from '~/lib'
...
export const SupersetForm: FC<SupersetFormProps> = ({
	...
	const vol = loggedVolume(allLogs.filter(l => isHardSet(l) && !uncheckedIds.has(l.id)))
