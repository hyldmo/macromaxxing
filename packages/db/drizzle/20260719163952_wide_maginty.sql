...
CREATE INDEX IF NOT EXISTS `exercise_equipment_exercise_id_idx` ON `exercise_equipment` (`exercise_id`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `exercise_equipment_unique_idx` ON `exercise_equipment` (`exercise_id`,`equipment`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `location_equipment_location_id_idx` ON `location_equipment` (`location_id`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `location_equipment_unique_idx` ON `location_equipment` (`location_id`,`equipment`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `locations_user_id_idx` ON `locations` (`user_id`);--> statement-breakpoint
