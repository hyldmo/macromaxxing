...
CREATE INDEX `workout_skips_user_id_idx` ON `workout_skips` (`user_id`);--> statement-breakpoint
CREATE INDEX `workout_skips_workout_id_idx` ON `workout_skips` (`workout_id`);