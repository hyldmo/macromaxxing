...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `rest_notification_jobs` (
	`id` text PRIMARY KEY NOT NULL,
	`user_id` text NOT NULL,
...
CREATE INDEX IF NOT EXISTS `rest_notification_jobs_user_id_idx` ON `rest_notification_jobs` (`user_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `rest_notification_jobs_session_id_idx` ON `rest_notification_jobs` (`session_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `rest_notification_jobs_subscription_id_idx` ON `rest_notification_jobs` (`subscription_id`);
