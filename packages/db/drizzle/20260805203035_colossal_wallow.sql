CREATE TABLE IF NOT EXISTS `_mpl_bk_inventory` AS SELECT * FROM `meal_plan_inventory`;--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `_mpl_bk_slots` AS SELECT * FROM `meal_plan_slots`;--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `__new_meal_plans` (
